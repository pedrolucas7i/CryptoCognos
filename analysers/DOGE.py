...
def analyse(price_history):
    ...
    if latest_data['Signal'] == 'Comprar':
        ...
        return "Indicação: O preço do DOGE tem potencial de subida com base nos indicadores técnicos.<br>Poderar comprar!"
    elif latest_data['Signal'] == 'Vender':
        print("Indicação: O preço do DOGE pode cair com base nos indicadores técnicos.\n")
        return "Indicação: O preço do DOGE pode cair com base nos indicadores técnicos.<br>Ponderar retirar!"
    else:
        print("Indicação: Nenhuma tendência clara detectada.\n")
        return "Indicação: Nenhuma tendência clara detectada.<br>Não mexer..."